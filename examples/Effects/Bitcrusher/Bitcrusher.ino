...
void setup() {
    ...
    */
    ...
    audioShield.autoVolumeControl(1, 1, 0, -6, 40,
                                  20); // **BUG** with a max gain of 0, turning the AVC off leaves a hung AVC problem where the attack seems to hang in a loop. with it set 1 or 2, this does not occur.
